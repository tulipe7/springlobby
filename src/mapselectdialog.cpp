	...
	m_vertical_direction( sett().GetVerticalSortorder() )
{
	...
	m_vertical_direction_button = new wxButton(this, ID_VERTICAL_DIRECTION, _T("^"), wxDefaultPosition, wxSize(CONTROL_HEIGHT,CONTROL_HEIGHT), 0, wxDefaultValidator, _T("ID_VERTICAL_DIRECTION"));
